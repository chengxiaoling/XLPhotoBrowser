...
//  XLPhotoBrowser
//
//  Created by kayling on 2019/4/28.
...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "XLImageCollectionCell", for: indexPath) as! XLImageCollectionCell
...
extension ViewController: AAPhotoBrowserProtocol {
    ...
    func photo(of index: Int, with browser: AAPhotoBrowser) -> AAPhoto {
        ...
        let cell = collectionView.cellForItem(at: IndexPath.init(item: index, section: 0)) as! XLImageCollectionCell
